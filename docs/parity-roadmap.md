...
P1 provides the typed durable workspace, dynamic pages, hotseat, internal drag, and deterministic reorder. P1.5 provides separate full-screen HOME and All Apps surfaces with swipe, Back, HOME-intent, IME, orientation, RTL, and large-font evidence. P2A provides typed, Room-backed folders with creation, rename, reorder, extraction, dissolution, and package reconciliation. Widgets, icon packs, dots, Private Space UI, and Quickstep stay out.
